...
💻 I build adaptive, multilingual web applications using React, TypeScript, Next.js, and Node.js with modern libraries and approaches.  
...
- Next.js (App Router, NextAuth, API Routes)  
- TypeScript, JavaScript, Vite, Axios, i18next  
- MUI (Material UI), TailwindCSS  
- REST API, authorization, forms, validation (Zod, React Hook Form, Joi)  
- GitHub, ESLint, architecture, Framer Motion  
- Backend: Node.js, Express, SQL, MongoDB, Firebase  

---
## 📄 Resume / CV
- [Open Resume repo](https://github.com/godoffirekirill/cv-kirill-kurochkin)
- [Download PDF](https://github.com/godoffirekirill/cv-kirill-kurochkin/raw/main/resume.pdf)


## 🚀 Latest Project

### 🔹 [mobil-one-nextjs](https://github.com/godoffirekirill/mobil-one-nextjs)  
Full-featured **website with admin panel** built on **Next.js 15 + Tailwind**.  
[🌐 Website](https://mobil1express.ru)  
➡️ Features:
- ✅ Admin panel with data stored in **JSON** (no DB needed for the task)  
- ✅ Backend integrated inside Next.js (API routes — no separate Express server required)  
- ✅ Form submissions sent directly to **Telegram bot**  
...
[🌐 Website](https://heelsonfire.ru)  

Landing page with form handling and honeypot spam protection  
➡️ React 19 + Vite, MUI Joy, TypeScript, Framer Motion, React Hook Form  
...
📦 Portfolio projects: Available via links above  
